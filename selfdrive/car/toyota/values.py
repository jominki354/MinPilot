...
MIN_ACC_SPEED = 19.0 * CV.MPH_TO_MS
PEDAL_TRANSITION = 10.0 * CV.MPH_TO_MS
...
class CarControllerParams:
    ...
    STEER_DELTA_DOWN = (
        25  # always lower than 45 otherwise the Rav4 faults (Prius seems ok with 50)
    )
...
STATIC_DSU_MSGS = [
    (
        ...
        1,
        3,
        b"\xf4\x01\x90\x83\x00\x37",
    ),
    (
        0x128,
        (CAR.HIGHLANDER, CAR.HIGHLANDERH, CAR.SIENNA, CAR.LEXUS_CTH, CAR.LEXUS_ESH),
        1,
        3,
        b"\x03\x00\x20\x00\x00\x52",
    ),
    (
        0x141,
        (
    ...
    (
        ...
        1,
        7,
        b"\x00\x00\x08\x12\x01\x31\x9c\x51",
    ),
    (
        0x161,
        (
        ...
        1,
        7,
        b"\x00\x1e\x00\x00\x00\x80\x07",
    ),
    (
        0x161,
        (CAR.HIGHLANDERH, CAR.HIGHLANDER, CAR.SIENNA, CAR.LEXUS_CTH, CAR.LEXUS_ESH),
        1,
        7,
        b"\x00\x1e\x00\xd4\x00\x00\x5b",
    ),
    (
        0x283,
        (
        ...
        0,
        3,
        b"\x00\x00\x00\x00\x00\x00\x8c",
    ),
    (
        0x2E6,
        (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH),
        0,
        3,
        b"\xff\xf8\x00\x08\x7f\xe0\x00\x4e",
    ),
    (
        0x2E7,
        (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH),
        0,
        3,
        b"\xa8\x9c\x31\x9c\x00\x00\x00\x02",
    ),
    (
        0x33E,
        (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH),
    ...
    (
        ...
        0,
        5,
        b"\x00\x00\x01\x00\x00\x00\x00\x50",
    ),
    (
        0x365,
        (CAR.PRIUS, CAR.LEXUS_RXH, CAR.LEXUS_NXH, CAR.LEXUS_NX, CAR.HIGHLANDERH),
        0,
        20,
        b"\x00\x00\x00\x80\x03\x00\x08",
    ),
    (
        0x365,
        (
...
DBC = {
    ...
    CAR.LEXUS_RXH_TSS2: dbc_dict(
        "toyota_nodsu_hybrid_pt_generated", "toyota_tss2_adas"
    ),
    ...
    CAR.HIGHLANDERH: dbc_dict(
        "toyota_highlander_hybrid_2018_pt_generated", "toyota_adas"
    ),
    CAR.HIGHLANDERH_TSS2: dbc_dict(
        "toyota_nodsu_hybrid_pt_generated", "toyota_tss2_adas"
    ),
...
NO_STOP_TIMER_CAR = TSS2_CAR | set(
    [CAR.RAV4H, CAR.HIGHLANDERH, CAR.HIGHLANDER, CAR.SIENNA, CAR.LEXUS_ESH]
)

FEATURES = {
    "use_lta_msg": set(
        [CAR.CAMRY_TSS2, CAR.CAMRYH_TSS2, CAR.HIGHLANDER_TSS2, CAR.HIGHLANDER_TSS2]
    )
}
