...
std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"CarModel", PERSISTENT},
    {"CarrotSpeedControl", PERSISTENT},
    {"CarrotMobileCamera", PERSISTENT},
    {"CarrotSpeedBump", PERSISTENT},
    {"CarrotSectionControl", PERSISTENT},
    ...
    {"CustomSteerRatioEnable", PERSISTENT},
    ...
    {"UIDevMode", PERSISTENT},
    {"CarrotCameraDist", CLEAR_ON_MANAGER_START},
    {"CarrotCameraType", CLEAR_ON_MANAGER_START},
